...
var TopicSubscriber = function (topicName) {
	...
	subscriber.push_odd = function (match) {
		var match_id = document.getElementById("match_id_r1");
		match_id.innerHTML = match.matchID;
		var match_status = document.getElementById("match_status_r1");
		match_status.innerHTML = match.matchStatus;
	};
	// Logger
